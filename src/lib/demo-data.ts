...
const BASE_USERS: any[] = [
  { id: 1, name: 'Анна', age: 24, img: '/demo/people/anna.png', hint: 'woman portrait', online: true, distance: 2, match: 87, city: 'Москва', zodiac: 'common.zodiac.leo', interests: ['interest.photography', 'interest.travel', 'interest.coffee', 'interest.music', 'interest.sport'], bio: 'Люблю закаты, хороший кофе и интересные разговоры.', height: 172, goal: 'goal.serious_relationship', gender: 'female', lookingFor: 'male', superLikes: 5, boost: { boostedUntil: futureDate }, circadian: 'lark' },
  
  // 10 Men for Anna (Москва, совпадающие интересы и цели)
  { id: 2, name: 'Александр', age: 26, img: '/demo/people/maxim.png', hint: 'man portrait', online: true, distance: 3, match: 95, city: 'Москва', zodiac: 'common.zodiac.aries', interests: ['interest.travel', 'interest.coffee', 'interest.sport'], bio: 'Всегда в движении. Ищу ту, кто разделит мою страсть к горам и кофе.', height: 185, goal: 'goal.serious_relationship', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'owl' },
  { id: 4, name: 'Михаил', age: 28, img: '/demo/people/ivan.png', hint: 'man portrait', online: false, distance: 5, match: 89, city: 'Москва', zodiac: 'common.zodiac.scorpio', interests: ['interest.music', 'interest.coffee', 'interest.photography'], bio: 'Играю на гитаре, варю лучший эспрессо. Давай сходим на концерт?', height: 182, goal: 'goal.dating', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'owl' },
  { id: 6, name: 'Артем', age: 25, img: '/demo/people/artem.png', hint: 'man portrait', online: true, distance: 4, match: 84, city: 'Москва', zodiac: 'common.zodiac.gemini', interests: ['interest.sport', 'interest.music', 'interest.travel'], bio: 'Кодю днем, бегаю вечером. Люблю умные разговоры.', height: 178, goal: 'goal.new_friends', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'lark' },
  { id: 8, name: 'Иван', age: 27, img: '/demo/people/ivan.png', hint: 'man portrait', online: false, distance: 8, match: 91, city: 'Москва', zodiac: 'common.zodiac.sagittarius', interests: ['interest.photography', 'interest.travel', 'interest.sport'], bio: 'Пейзажный фотограф. Мечтаю о поездке в Исландию.', height: 188, goal: 'goal.serious_relationship', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'owl' },
  { id: 10, name: 'Никита', age: 30, img: '/demo/people/maxim.png', hint: 'man portrait', online: false, distance: 6, match: 78, city: 'Москва', zodiac: 'common.zodiac.aquarius', interests: ['interest.coffee', 'interest.music', 'interest.photography'], bio: 'Ценю искренность и хороший юмор. Люблю открывать новые кофейни.', height: 180, goal: 'goal.just_talk', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'lark' },
  { id: 11, name: 'Дмитрий', age: 32, img: '/demo/people/maxim.png', hint: 'man portrait', online: true, distance: 2, match: 92, city: 'Москва', zodiac: 'common.zodiac.taurus', interests: ['interest.sport', 'interest.coffee', 'interest.travel'], bio: 'Люблю активный отдых и продуктивные утра. Ищу серьезные отношения.', height: 184, goal: 'goal.serious_relationship', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'lark' },
  { id: 12, name: 'Максим', age: 29, img: '/demo/people/maxim.png', hint: 'man fashion', online: false, distance: 4, match: 86, city: 'Москва', zodiac: 'common.zodiac.capricorn', interests: ['interest.music', 'interest.photography', 'interest.sport'], bio: 'Меломан и эстет. Люблю находить красоту в мелочах.', height: 179, goal: 'goal.dating', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'owl' },
  { id: 13, name: 'Андрей', age: 31, img: '/demo/people/ivan.png', hint: 'man professional', online: true, distance: 7, match: 83, city: 'Москва', zodiac: 'common.zodiac.libra', interests: ['interest.travel', 'interest.coffee', 'interest.music'], bio: 'Архитектор. Ищу вдохновение и интересного собеседника.', height: 181, goal: 'goal.new_friends', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'lark' },
  { id: 14, name: 'Игорь', age: 24, img: '/demo/people/artem.png', hint: 'man fitness', online: true, distance: 1, match: 94, city: 'Москва', zodiac: 'common.zodiac.cancer', interests: ['interest.sport', 'interest.photography', 'interest.travel'], bio: 'Жизнь — это приключение. Давай напишем свою историю вместе?', height: 176, goal: 'goal.serious_relationship', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'owl' },
  { id: 15, name: 'Виктор', age: 35, img: '/demo/people/ivan.png', hint: 'man intellectual', online: false, distance: 9, match: 81, city: 'Москва', zodiac: 'common.zodiac.virgo', interests: ['interest.coffee', 'interest.music', 'interest.sport'], bio: 'Спокойный, надежный, ценю уют и хороший джаз.', height: 183, goal: 'goal.dating', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null }, circadian: 'lark' },

  // Other Women
  { id: 3, name: 'Елена', age: 26, img: '/demo/people/elena.png', hint: 'woman portrait', online: false, distance: 3, match: 81, city: 'Москва', zodiac: 'common.zodiac.pisces', interests: ['interest.art', 'interest.books', 'interest.cooking'], bio: 'Ищу кого-то, кто любит музеи и долгие прогулки.', height: 168, goal: 'goal.dating', gender: 'female', lookingFor: 'male', superLikes: 0, boost: { boostedUntil: null }, circadian: 'owl' },
  { id: 5, name: 'София', age: 22, img: '/demo/people/sophia.png', hint: 'woman portrait', online: true, distance: 7, match: 88, city: 'Москва', zodiac: 'common.zodiac.virgo', interests: ['interest.music', 'interest.art', 'interest.photography'], bio: 'Мечтаю собрать свою группу и объехать мир.', height: 165, goal: 'goal.just_talk', gender: 'female', lookingFor: 'male', superLikes: 0, boost: { boostedUntil: null }, circadian: 'lark' },
  { id: 7, name: 'Мария', age: 29, img: '/demo/people/anna.png', hint: 'woman portrait', online: true, distance: 1, match: 94, city: 'Москва', zodiac: 'common.zodiac.scorpio', interests: ['interest.yoga', 'interest.nature', 'interest.travel'], bio: 'Люблю готовить полезную еду и ходить в походы.', height: 170, goal: 'goal.serious_relationship', gender: 'female', lookingFor: 'male', superLikes: 0, boost: { boostedUntil: null }, circadian: 'lark' },
  { id: 9, name: 'Ксения', age: 23, img: '/demo/people/sophia.png', hint: 'woman portrait', online: true, distance: 6, match: 83, city: 'Москва', zodiac: 'common.zodiac.capricorn', interests: ['interest.fashion', 'interest.design', 'interest.art'], bio: 'Жизнь слишком коротка, чтобы носить скучную одежду.', height: 174, goal: 'goal.serious_relationship', gender: 'female', lookingFor: 'male', superLikes: 0, boost: { boostedUntil: null }, circadian: 'owl' },

  // 5 идеальных кандидатов для Анны (Автопоиск)
  { id: 18, name: 'Егор', age: 25, img: '/demo/people/maxim.png', hint: 'man portrait', online: true, distance: 2, match: 97, city: 'Москва', zodiac: 'common.zodiac.sagittarius', interests: ['interest.photography', 'interest.travel', 'interest.coffee', 'interest.music'], bio: 'Фотограф-путешественник. Ищу музу для совместных приключений и уютных вечеров с кофе.', height: 183, goal: 'goal.serious_relationship', gender: 'male', lookingFor: 'female', superLikes: 3, boost: { boostedUntil: futureDate }, circadian: 'lark' },
  { id: 19, name: 'Тимур', age: 26, img: '/demo/people/artem.png', hint: 'man fitness', online: true, distance: 4, match: 96, city: 'Москва', zodiac: 'common.zodiac.leo', interests: ['interest.sport', 'interest.music', 'interest.travel', 'interest.photography'], bio: 'Фитнес-тренер и меломан. Утро начинаю с пробежки, вечер — с гитары. Ищу вторую половинку.', height: 186, goal: 'goal.serious_relationship', gender: 'male', lookingFor: 'female', superLikes: 2, boost: { boostedUntil: null }, circadian: 'lark' },
  { id: 20, name: 'Даниил', age: 27, img: '/demo/people/ivan.png', hint: 'man portrait', online: true, distance: 3, match: 95, city: 'Москва', zodiac: 'common.zodiac.taurus', interests: ['interest.coffee', 'interest.travel', 'interest.sport', 'interest.music'], bio: 'Бариста и путешественник. Варю лучший кофе в городе. Мечтаю объехать всю Европу на машине.', height: 180, goal: 'goal.serious_relationship', gender: 'male', lookingFor: 'female', superLikes: 1, boost: { boostedUntil: null }, circadian: 'lark' },
  { id: 21, name: 'Матвей', age: 24, img: '/demo/people/artem.png', hint: 'man fitness', online: true, distance: 5, match: 98, city: 'Москва', zodiac: 'common.zodiac.gemini', interests: ['interest.music', 'interest.sport', 'interest.photography', 'interest.travel'], bio: 'Музыкант и спортсмен. Играю в группе, бегаю марафоны. Ищу девушку, с которой будет не скучно.', height: 177, goal: 'goal.serious_relationship', gender: 'male', lookingFor: 'female', superLikes: 4, boost: { boostedUntil: futureDate }, circadian: 'lark' },
  { id: 22, name: 'Роман', age: 28, img: '/demo/people/ivan.png', hint: 'man portrait', online: false, distance: 1, match: 93, city: 'Москва', zodiac: 'common.zodiac.libra', interests: ['interest.photography', 'interest.music', 'interest.coffee', 'interest.travel'], bio: 'Программист в душе и романтик в сердце. Люблю закаты, джаз и долгие прогулки. Ищу серьёзные отношения.', height: 184, goal: 'goal.serious_relationship', gender: 'male', lookingFor: 'female', superLikes: 2, boost: { boostedUntil: null }, circadian: 'lark' }
];
